...
with open("{}/model.json".format(WORKING_DIR), "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("{}/model.h5".format(WORKING_DIR))
...
# Saving results
sub.to_csv("{}/results_inception.csv".format(WORKING_DIR), mode='w', index=False)
